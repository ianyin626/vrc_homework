...
int detectRobotStatus() {
    while (true) {
        ...
        Brain.Screen.printAt(0, 100, "upIntakeTemp: %.0f", upIntake.temperature(temperatureUnits::celsius));
        Brain.Screen.printAt(200, 100, "DownIntakeTemp: %.0f", downIntake.temperature(temperatureUnits::celsius));
        Brain.Screen.printAt(0, 120, "IntakeVoltage: %.0f", upIntake.voltage(voltageUnits::mV));
        Brain.Screen.printAt(200, 120, "IntakeRPM: %.0f", upIntake.velocity(velocityUnits::rpm));
